...
const RootStackScreen = () => {
  return (
    // <RootStack.Navigator>
    //   {/* <RootStack.Screen options={{ headerShown: false }} name="home" component={GoogleMap} /> */}
    //   {/* <RootStack.Screen options={{ headerStyle: { backgroundColor: 'orange' } }} name="EmergencyDetails" component={EmergencyDetails} /> */}
    //   {/* <RootStack.Screen options={{ headerShown: false }} name="SignUpScreen" component={SignInScreen} /> */}

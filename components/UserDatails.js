    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.sliderContainer}>
                <Image
                    source={require('../assets/banners/heart-attack.jpg')}
                    style={styles.userprofile}
                    resizeMode="cover"
                />
                <View style={styles.userInfo}>
                    <Text style={styles.userName}>Rampal Sharma</Text>
                </View>
            ...
            <View style={styles.categoryContainer}>
                <TouchableOpacity
                    ...
                    <View style={styles.categoryIcon}>
                        <Text size={35} color="#FF6347">31</Text>
                    </View>
                ...
                <TouchableOpacity
                    ...
                    <View style={styles.categoryIcon}>
                        {/* <MaterialCommunityIcons
                            ...
                            color="#FF6347"
                        /> */}
                        <Text size={35} color="#FF6347">O +ve</Text>
                    </View>
                    <Text style={styles.categoryBtnTxt}>Blood Group</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.categoryBtn} onPress={() => { }}>
                    <View style={styles.categoryIcon}>
                        <Text size={35} color="#FF6347">Male</Text>
                    </View>
            ...
            <View style={[styles.categoryContainer, { marginTop: 10 }]}>
                ...
                <TouchableOpacity style={styles.categoryBtn} onPress={() => { }}>
                    ...
                    <Text style={styles.categoryBtnTxt}>Friend</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.categoryBtn} onPress={() => { }}>
                    <View style={styles.categoryIcon}>
